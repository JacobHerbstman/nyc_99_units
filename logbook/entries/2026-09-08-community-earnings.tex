...
\clearpage
\begin{center}
\includegraphics[page=1,width=\textwidth,height=.95\textheight,keepaspectratio]{../tasks/audits/audit_acs_construction_wages/output/community_district_earnings_map.pdf}
\end{center}
