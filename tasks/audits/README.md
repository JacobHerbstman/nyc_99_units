...
Use audits for diagnostics, coverage checks, source comparisons, validation tables, manual-review samples, exploratory plots, and other outputs that do not serve as paper-facing outputs, downstream handoff files, or canonical production data.
