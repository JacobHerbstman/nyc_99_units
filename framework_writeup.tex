...
\input{tasks/audits/audit_scale_shape_splitting/temp/scale_shape_splitting_figure_guide_values.tex}
...
The descriptive parent population begins at six units. The preferred shape comparison begins at 50 parent units and retains all larger parents in its denominator. The reweighted comparison requires complete parcel characteristics. Historical parcel attributes use lagged MapPLUTO releases; recent attributes use release 23v3.1. Positive calibration weights match log lot area, residential floor-area ratio, built floor-area ratio, and borough. Constituent organization within the given parent site is a modeled policy response.
