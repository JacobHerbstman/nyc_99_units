...
\FigurePage
  ...
  {Historical parents are reweighted to match post-period residential FAR and borough before comparing the number of constituents. Parcel attributes are aggregated over observed parent boundaries.}
...
\FigurePage
  ...
  {The blue line reweights the exact 2019-2022 parent-size distribution to match post-period residential FAR and borough. The red line is observed post-policy.}
