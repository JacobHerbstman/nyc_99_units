...
file_index <- read_csv("../input/mappluto_raw_files.csv", show_col_types = FALSE) |>
  filter(status == "loaded") |>
  mutate(parquet_path = paste0("../../stage_mappluto_lots/output/", sanitize_file_stub(paste(source_id, vintage, sep = "_")), ".parquet")) |>
