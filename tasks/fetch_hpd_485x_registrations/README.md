...
dataset and its Socrata metadata, pulled August 20, 2026, and writes an
inventory, `output/hpd_485x_registration_files.csv`. Each source row is a
...
URLs. Files are copied only when missing; the inventory rule re-verifies them
