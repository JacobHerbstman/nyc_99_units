...
## 12. September 10: unit schedules and remaining boundaries

This update follows the automatic refiling correction. It applies documentary unit corrections through the committed manual source and retains the original HDB-priority and DOB fields. The selected measure is an **observed proposed apartment design**, not the immutable design at the original filing date. A different count in an older article is therefore not automatically a data error.

### Decisions supported by the additional research

| Case | Decision and evidence | Effect |
|---|---|---|
| 1920 Turnbull | HDC's June 2026 authorization, PDF page 17, enumerates 142 studios + 54 one-bedroom + 32 two-bedroom apartments. Gilbane identifies 137 supportive apartments + 90 other affordable apartments + one superintendent. | Correct 91 to **228**. With the second filing's saved 207, the parent becomes **435**, an increase of **137**. Raw fields remain 91. |
| 688/670 Boyland | Kao-Hwa Lee zoning sheet Z-001, marked B01328447-I1 and dated December 3, 2025, explicitly proposes Building A 86 and Building B 28. | Confirm **114**, retaining 28 rather than the competing DOB field of 29. Both documented counts enter the manual source. |
| Astoria Cove | GEI's December 2023 report, section 1.6 on PDF page 9, maps Phase 1 Buildings 3A/3B, 4 and 5 to the four same-day January 13, 2022 filing lots. | Join the two existing parents in both linkage routes. Retain **138+108+90+240 = 576** in the saved unit vintage. Later 731-unit financing/supporting filings do not establish a common original unit schedule. |
| Nostrand Land / Queens | August 6, 2025 reporting names the three filings and common Hurwitz/Cavu/Frankl team, with **253** total units. | Independently corroborates **84+87+82**. The reported 38-10 versus saved 38-12 33rd Street alias remains noted. |
| River North | The contractor PINE lists 8 Stuyvesant at **280** and 178 Richmond at **393**, matching the saved data. The third component is 126. | Retain **799** as a later observed program. The contractor page is undated; it does not convert 799 into the first-filed 2022 choice. |
| Linden Terrace II/III | HDC identifies 160 and 156 apartments under Radson; saved filings are 21 days apart in 2019. | Retain **316** under the established common-development/365-day rule. Record the separate financing phases; do not infer simultaneous construction. |
| Rockaway Village III/IV | HDC identifies Phase III at 354 and Phase IV at 184 (1605/1607 Village Lane). All three saved applications were filed May 8, 2020. | Retain **538** as the economic opportunity. Separate financing phases remain documented. |
| Coney Island neighbor | DEC identifies 1515 Surf/2925 West 16th as LCOR's Surf Avenue L/CAL project. The leasing broker identifies 1601 Surf/2938 West 16th as the BFC/L+M project. | Explicitly reject the nearby cross-project pair. No current membership changes. |
| Ninth Avenue neighbors | ZD Jasper's own 2024 summary lists 489 Ninth, 439 West 36th and 430 West 37th as separate projects. NYSERDA groups 439 and the Ninth buildings in one energy-design award; 430 has its own construction financing. | Retain the three existing economic parents. Shared developer and award participation do not alone turn the portfolio into one development. |
| Wilson/Boston | Retain the reviewed distinct project boundaries and design teams. The Boston declaration excludes Wilson's lot 6. | Close the **baseline separation** decision, while retaining the qualification that ultimate beneficial independence is not established. |

Primary sources: [HDC Turnbull authorization](https://www.nychdc.com/sites/default/files/2026-06/0.%20Memo-Approval%20of%20an%20Authorizing%20Resolution%20relating%20to%20Multi%20Family%202026%20Series%20G-K-Final%20Signed.pdf), [Gilbane apartment breakdown](https://www.gilbaneco.com/projects/1920-turnbull/), [Boyland zoning drawing](https://www.pincusco.com/property-data/ZD1_B01328447_2.pdf), [GEI Astoria Cove report](https://extapps.dec.ny.gov/data/DecDocs/C241295/Application.BCP.C241295.2023-12-01.Phase%20I%20Report%20.pdf), [PINE projects](https://www.pinecustomhomes.com/wip-builds), [Rockaway HDC notice](https://www.nychdc.com/sites/default/files/2021-11/Nov%2018%202021%20HDC%20TEFRA%20Notice%20-%20Final%2011.10.21.pdf), [HDC phase totals](https://www.nychdc.com/sites/default/files/2026-05/REMIC%20Report%20to%20Members%202025-FINAL.pdf), [ZD Jasper's project list](https://www.linkedin.com/posts/zd-jasper_2024-summary-4-buildings-309-units-completed-activity-7279202877414244352-VAQv), [NYSERDA award description](https://www.nyserda.ny.gov/All-Programs/Multifamily-Buildings-of-Excellence/Winners), [LCOR certificate](https://extapps.dec.ny.gov/data/DecDocs/C224310/Certificate%20of%20Completion.BCP.C224310.2022-12-28.Executed%20COC%20Package.pdf), and [BFC leasing broker](https://tristatecr.com/pharmacy-set-to-open-at-coney-island-development/). The [contemporaneous Queens report](https://therealdeal.com/new-york/2025/08/06/how-to-buy-a-rent-stabilized-lease-pay-for-renovations/) corroborates Nostrand's total. Linden sources remain linked in the individual casebook.

### Questions that this review could not close

- **30 Wharf, B00680267:** 483/40 stories in saved records versus 104/9 stories in the secondary property/job page. Current neighboring filings also show different unit programs. The DOS waterfront package was unavailable by both Browser and direct download. The needed evidence is a dated job/BIN-specific architectural schedule and site plan; neither count is silently substituted.
- **769 East 232nd, X00521651:** 55 units is implausible alongside the saved four-story/small-area description, but repeated permit reporting is not independent validation. DOB's public property profile identifies BIN 2130604 and lot 85, but its Building Schedule of Occupancy action returned “Schedule of Occupancy not found for this BIN.” The job grid returned no rows in this session. That is an access/coverage limitation, not proof that the filing never existed. A proposed floor-by-floor schedule is needed before correcting 55.
- **344 Grand Concourse, X01252512:** HDB 56 versus DOB 59. The complete August 2025 DEC application establishes the 338/344 site but explicitly contains no development plans. It cannot resolve the later dwelling schedule; retain both counts and request the architectural schedule from the public record before certification.
- **54-08 Myrtle, Q01338971:** HDB 99 versus DOB I1 79; later supporting records include both. The linked zoning file is an HTML Access Denied page saved with a PDF name. Format validation prevented it from entering the acquired snapshot. The live property profile now carries an August 2026 address reassignment for lot 1, further reason to use job/BIN identifiers. The competing 289/269 parent totals remain unresolved.
- **Beach 30th, Q01222315:** the common three-building 230-unit development is supported, but the saved 147 versus reported 155 address needs a job-specific crosswalk. The previously linked ZAP approval package was unavailable. Same lot and matching program are supporting evidence, not a substitute for that crosswalk.
- **Mount Hope, X01222893/X01222960:** all saved rows say 99 per building. September 2026 reporting says 99 at 29 Mt Hope and 246 on the broader site. It postdates our capture and does not identify the other 48 units. Retain 198 for this vintage; do not create a companion from the difference or attach unrelated 22 Mount Hope.
- **Boone across the street:** 1660, 1006 East 173rd and 1563 Boone share a named developer/architect, but no additional document found establishes one project or common financing across these sites. The researched 1660/1674 rejection remains in force. The broader same-sponsor opportunity boundary is still open.

River North and Astoria Cove also retain a **unit-date limitation**: the observed program is not a recovered initial choice. Third Avenue's dated 297-unit design is already documented; that issue is distinct from whether its raw I1 fields reproduce the initial submission.

The changes do not finalize the full data for estimation. They resolve supported counts and boundaries and preserve the cases requiring inaccessible or missing schedules. The broader citywide neighbor screen still contains unadjudicated candidates outside the original case set. No estimator was run.


## 13. September 10 follow-up: filing evidence versus broader programs

Jacob requests filing-reported units. This supersedes the interpretation of the Turnbull override above: HDC's 228-apartment financing program does not establish the dwelling-unit count reported in DOB. The saved I1 and nine supporting filings all report 91. The production comparison is recorded in the README and reproducible `dob_unit_filings.csv` / `dob_unit_parents.csv`; it is not an adopted change to historical coverage or original-submission timing.

The renewed check also distinguishes actual missing evidence from conflicts that should not, by themselves, block use of the recorded filing measure:

- **769 East 232nd:** the saved DOB record reports 55 units and 22,680 construction square feet. The earlier 7,499 residential-square-foot concern came from Marketproof. [December 16, 2021 filing coverage](https://www.pincusco.com/ben-baum-files-plans-for-55-unit-resi-building-in-wakefield/) identifies X00521651 and describes 10 basement + 14 ground + 14 second + 14 third + 3 fourth-floor units = 55. This supports retaining the filed 55; the article is corroboration, not an independently inspected DOB drawing.
- **Wharf:** the saved B00680267 record explicitly describes a forty-story development, with 483 units and 448,743 construction square feet. [March 2, 2022 reporting](https://www.pincusco.com/halcyon-management-files-plans-for-104-unit-resi-building-in-greenpoint-third-nb-plans-at-the-site-in-a-week/) identifies the same job under the former 75 Private Drive address, then nine stories and 104 units. This is a dated design discrepancy, not evidence that the saved current filing fails to say 483. The earlier small building is not grounds to replace the current filed count. Reconstructing the original design and checking the multi-phase boundary remain separate questions.
- **Grand Concourse:** HDB's September 22, 2025 record reports 56 units and eleven stories; the saved DOB record reports 59 and twelve stories, approved June 30, 2026. All ten retained DOB records for this root carry 59. These dates and heights make a revised design a plausible explanation, but they do not identify the exact amendment that changed the count. A DOB-I1 convention selects 59 without calling 56 a transcription error.
- **Myrtle:** the main I1 record reports 79, as do the two saved standpipe/sprinkler records; the mechanical supporting filing reports 99 and a different area. A main-application convention selects 79 rather than substituting the mechanical count or the older HDB count of 99. The source conflict remains documented.
- **Beach:** the [155 Beach 30 Street property record](https://www.pincusco.com/property/155-beach-30-street/) explicitly names Q01222315, the same job, 57 units and block/lot 15822/44 as the saved 147 Beach 30 record. That is stronger job-level corroboration than my earlier statement acknowledged. All ten saved DOB records carry the 147 address and 57 units. The address alias does not justify changing those units or adding another building; an official alias record would further strengthen the boundary documentation.
- **Mt Hope:** the saved 23/29 Mt Hope applications and supporting records carry 99 each. September 2026 reporting's 246 has no identified corresponding filing in the saved vintage and is not a reason to replace 198 or invent another 48 units. A post-capture proposal, if found, would be a later-vintage question.
