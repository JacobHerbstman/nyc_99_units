...
.PHONY: all setup-environment source-registry paper framework-writeup \
	check-bunching check-parent-model check-developer-response-audit
...
framework_writeup.pdf: framework_writeup.tex \
	...
	tasks/audits/audit_developer_responses/output/developer_response_provisional_site_construction_area_vs_units.pdf \
	tasks/audits/audit_developer_responses/output/developer_response_provisional_site_construction_square_feet_per_unit.pdf \
	tasks/audits/audit_developer_responses/output/developer_response_provisional_site_building_application_counts.pdf
...
tasks/audits/audit_developer_responses/output/developer_response_provisional_site_construction_area_vs_units.pdf \
tasks/audits/audit_developer_responses/output/developer_response_provisional_site_construction_square_feet_per_unit.pdf \
tasks/audits/audit_developer_responses/output/developer_response_provisional_site_building_application_counts.pdf: check-developer-response-audit
...
check-developer-response-audit:
	$(MAKE) -C tasks/audits/audit_developer_responses/code \
