...
\input{../output/figure_guide_values.tex}
...
\addlinespace
Composition adjustment & Positive exponential weights compare \CalibrationHistoricalParents{} historical parents with \CalibrationPostParents{} post parents using archival parcel characteristics and borough. Effective historical sample size is \CalibrationESS{}; weights range from \MinimumCalibrationWeight{} to \MaximumCalibrationWeight{}. \\
\addlinespace
Inference & \SuccessfulBootstraps{} of \RequestedBootstraps{} bootstrap recalibrations succeeded. Historical-window and forward-placebo checks are reported in the separate counterfactual audit. \\
\bottomrule
\end{tabular}
...
\FigurePage
  ...
  {../input/annualized_parent_total_50_300.pdf}
...
\FigurePage
  ...
  {../input/normalized_parent_total_50_300_reproduction.pdf}
...
\FigurePage
  ...
  {../input/normalized_parent_total_50_plus.pdf}
...
\FigurePage
  ...
  {Historical parents are reweighted to match post-period log lot area, residential FAR, built FAR, and borough before comparing the number of constituents. Parcel attributes are aggregated over observed parent boundaries.}
...
\FigurePage
  ...
  {The blue line reweights the exact 2019-2022 parent-size distribution to match post-period log lot area, residential FAR, built FAR, and borough. The red line is observed post-policy.}
...
\FigurePage
  ...
  {Exact one-unit histograms are noisy from year to year, but none displays the post-period 99 or 198 concentrations. Formal window and forward-placebo checks are kept in the separate counterfactual audit.}
