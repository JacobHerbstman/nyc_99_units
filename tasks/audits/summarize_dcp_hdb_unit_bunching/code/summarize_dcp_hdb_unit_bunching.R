...
write_csv_atomic(year_summary, "../output/dcp_hdb_unit_bunching_year_summary.csv")
write_csv_atomic(sample_qc, "../output/dcp_hdb_unit_bunching_sample_qc.csv")
write_csv_atomic(exact_counts, "../output/dcp_hdb_unit_bunching_exact_counts.csv")
write_csv_atomic(period_summary, "../output/dcp_hdb_unit_bunching_period_summary.csv")
write_csv_atomic(pre_post_exact_comparison, "../output/dcp_hdb_unit_bunching_pre_post_exact_comparison.csv")
write_csv_atomic(top_spikes, "../output/dcp_hdb_unit_bunching_top_spikes.csv")
write_csv_atomic(near_threshold_by_year, "../output/dcp_hdb_unit_bunching_near_threshold_by_year.csv")
write_csv_atomic(date_basis_sensitivity, "../output/dcp_hdb_unit_bunching_date_basis_sensitivity.csv")
write_csv_atomic(status_sensitivity, "../output/dcp_hdb_unit_bunching_status_sensitivity.csv")
write_csv_atomic(pre_period_sensitivity, "../output/dcp_hdb_unit_bunching_pre_period_sensitivity.csv")
write_csv_atomic(pre_period_cut_plot_counts, "../output/dcp_hdb_unit_bunching_pre_period_cut_plot_counts.csv")
write_csv_atomic(monthly_2024_2025_99, "../output/dcp_hdb_unit_bunching_2024_2025_monthly_99.csv")
write_csv_atomic(applications_2025_99, "../output/dcp_hdb_unit_bunching_2025_99_applications.csv")
write_csv_atomic(geography_2025_99, "../output/dcp_hdb_unit_bunching_2025_99_geography.csv")
write_csv_atomic(duplicate_site_qc, "../output/dcp_hdb_unit_bunching_duplicate_site_qc.csv")
